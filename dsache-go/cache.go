...
// Cache is an interface used for performing caching operations on the CacheStore.
...
// CacheStore is a simple in-memory key value pair store.
...
// New creates and returns a new instance of the CacheStore with initialized internal data.
...
func (c *CacheStore) Set(key, value []byte, ttl time.Duration) error {
